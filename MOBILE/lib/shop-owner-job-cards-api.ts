...
import { parseJobCardsFromPagePayload, pickJobCardNoForApi } from "@/lib/shop-owner-job-cards";
import { MAX_JOB_CARD_VEHICLE_PHOTOS } from "@/lib/auto-shop-owner-api";
...
export type SaveJobCardInput = {
  ...
  vehiclePhotoFiles: import("@/lib/upload-part").UploadPart[];
