...
import { usePaginatedAutoShopOwnerCities } from "@/hooks/use-paginated-user-cities";
...
export function ShopOwnerCityPickerModal({ visible, onClose, authToken, selectedId, onSelect }: Props) {
  ...
  const { items, loading, loadingMore, hasMore, loadMore } = usePaginatedAutoShopOwnerCities(
    authToken,
    visible,
    debouncedSearch
  );
...
const styles = StyleSheet.create({
  ...
  rowSelected: { backgroundColor: colors.primaryMutedBg, marginHorizontal: -4, paddingHorizontal: 8, borderRadius: 12 },
