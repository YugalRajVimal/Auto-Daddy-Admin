...
// // // // // ADD "India" TO Country type
// // // // type Country = "Canada" | "USA" | "India";
...
// // // // // Add "India" to searchable fields and sort alphabetically
...
// // // //                 </button>
// // // //               ))}
// // // //               {value && !sortedOptions.includes(value) && (
// // // //                 <button
// // // //                   type="button"
...
// // // //     }
// // // //   }
// // // //   // Sort rows by country first alphabetically, then by make, then by model
// // // //   rows.sort((a, b) => {
...
// // // //   // Sort the filtered rows alphabetically by country, then make, then model
...
// // // //       rows: sortedFiltered.map((row) => [row.make, row.model, row.country, row.brandLogo ? "Yes" : "—"]),
// // // //     });
// // // //   };
  ...
  const handleRenameMake = async (oldName: string, newName: string): Promise<boolean> => {
    ...
    if (existingCompany) {
      ...
      try {
        ...
        formData.append("country", existingCompany.country || "Canada");
