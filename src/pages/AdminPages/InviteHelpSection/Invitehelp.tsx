...
// const Invitehelp = () => {
//   const [inviteHelps, setInviteHelps] = useState([]);
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState('');

//   // Util function: Audio Buffer to Blob URL
//   function arrayBufferToBlobUrl(buffer: Uint8Array, mimeType = 'audio/webm') {
//     // Handles both Array and Buffer
//     const arr = buffer instanceof Uint8Array ? buffer : new Uint8Array(buffer as ArrayBuffer);
...
//           `${import.meta.env.VITE_API_URL}/api/admin/invite-help`
//         );
...
//   return (
//     <div>
//       <h2>Invite Help Requests</h2>
//       {loading ? (
//         <div>Loading...</div>
//       ) : error ? (
//         <div style={{ color: 'red' }}>{error}</div>
//       ) : inviteHelps.length === 0 ? (
//         <div>No invite help requests found.</div>
//       ) : (
//         <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: 20 }}>
//           <thead>
//             <tr>
//               <th style={{ border: "1px solid #ccc", padding: 8 }}>User Name</th>
//               <th style={{ border: "1px solid #ccc", padding: 8 }}>User Email</th>
//               <th style={{ border: "1px solid #ccc", padding: 8 }}>Business Name</th>
//               <th style={{ border: "1px solid #ccc", padding: 8 }}>Business Email</th>
//               <th style={{ border: "1px solid #ccc", padding: 8 }}>Message</th>
//               <th style={{ border: "1px solid #ccc", padding: 8 }}>Audio</th>
//               <th style={{ border: "1px solid #ccc", padding: 8 }}>Created At</th>
//             </tr>
//           </thead>
//           <tbody>
//             {inviteHelps.map((invite: any) => {
//               // Prepare audio element if audioBlob exists and has 'data' and 'type' === 'Buffer'
//               let audioUrl = null;
//               if (
//                 invite.audioBlob &&
...
//                 const arr = new Uint8Array(invite.audioBlob.data);
//                 // You may want to save/cleanup the blob URLs on unmount for memory management
//                 audioUrl = arrayBufferToBlobUrl(arr); // You may adjust mimeType here if needed
//               }

//               return (
//                 <tr key={invite._id}>
//                   <td style={{ border: "1px solid #ccc", padding: 8 }}>
//                     {invite.userId?.name || 'N/A'}
//                   </td>
//                   <td style={{ border: "1px solid #ccc", padding: 8 }}>
//                     {invite.userId?.email || 'N/A'}
//                   </td>
//                   <td style={{ border: "1px solid #ccc", padding: 8 }}>
...
//                   <td style={{ border: "1px solid #ccc", padding: 8 }}>
//                     {audioUrl ? (
//                       <audio controls src={audioUrl} style={{ maxWidth: 200 }} />
//                     ) : (
//                       'N/A'
//                     )}
//                   </td>
