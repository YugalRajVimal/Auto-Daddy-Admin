        ...
        <div className="flex flex-wrap gap-1">
          {!isDeletedView && (
            <button
              type="button"
              onClick={() => {
                const row = allCities.find((r) => selected.has(getCityRowId(r)));
                if (row) openEdit(row);
              }}
        ...
        <table className="w-full border-collapse text-sm whitespace-nowrap">
          <thead>
            <tr className="bg-ad-purple text-white ad-thead">
              ...
              <th className="ad-th border border-ad-purple-dark px-3 py-2 text-left font-medium">Name City</th>
              <th className="ad-th border border-ad-purple-dark px-3 py-2 text-left font-medium">Name Province</th>
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan={4} className="ad-td border border-gray-300 px-3 py-4 text-left text-gray-500">
                  Loading...
                </td>
              </tr>
            ) : paged.length === 0 ? (
