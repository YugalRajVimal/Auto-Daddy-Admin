import { adminClipImageUrl } from "../../../components/admin/ClipImageHover";
...
export const DUMMY_EXPENSES: LedgerRow[] = [
  { id: 1, date: "2026-05-24", vendor: "ABHAY", amount: 100, category: "other-expenses", subcategory: "misc", notes: "", gst: false, billNumber: null, byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("expense-1") },
  ...
  { id: 4, date: "2026-05-21", vendor: "SURBHI WEB DEV", amount: 350, category: "professional", subcategory: "software-charges", notes: "Website maintenance", gst: true, billNumber: "SWD-221", byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("expense-4") },
  { id: 5, date: "2026-05-20", vendor: "PAHADI-APP", amount: 500, category: "professional", subcategory: "software-charges", notes: "App subscription", gst: true, billNumber: null, byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("expense-5") },
  ...
  { id: 7, date: "2026-05-18", vendor: "DETAIL PRO", amount: 275, category: "car-vehicle", subcategory: "detailing", notes: "Fleet vehicle detailing", gst: true, billNumber: null, byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("expense-7") },
  ...
  { id: 10, date: "2026-05-10", vendor: "TORONTO HYDRO", amount: 320, category: "utilities", subcategory: "electricity", notes: "", gst: true, billNumber: "TH-99102", byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("expense-10") },
...
export const DUMMY_INCOME: LedgerRow[] = [
  ...
  { id: 4, date: "2026-05-20", vendor: "NORTHERN DEALERS", amount: 890, category: "product-sales", subcategory: "parts", notes: "Bulk parts order", gst: true, billNumber: "SO-8821", byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("income-4"), attachmentName: "parts-invoice.pdf" },
  ...
  { id: 9, date: "2026-05-08", vendor: "TORONTO TIRE MASTERS", amount: 1100, category: "service-revenue", subcategory: "repairs", notes: "Tire installation — 4 vehicles", gst: true, billNumber: "JOB-1044", byCheque: true, hasReceipt: true, attachmentUrl: adminClipImageUrl("income-9") },
