...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  const utilityLinkClass =
    "px-2.5 py-1 text-[11px] text-gray-500 hover:text-gray-700 hover:underline sm:px-3";
    ...
    <div className="flex min-h-screen flex-col bg-ad-app-bg font-sans">
      <div className="mx-auto flex w-full min-h-0 flex-1 flex-col lg:max-w-[1350px]">
        ...
        <div className="flex justify-end">
          <nav
            className="flex w-fit items-center gap-1 border-b border-gray-100 bg-gray-50 sm:gap-2"
        ...
        {/* Sub nav */}
        {subItems.length > 0 && (
          <div className="relative z-10 -mt-px border-b-2 border-ad-purple bg-white pl-4 md:pl-6">
