...
/** Job card create/edit form — roomier in-card padding. */
export const jobCardFormPanelContentClass = "min-h-[96px] space-y-4 px-6 py-6 sm:px-8 sm:py-7";
export const jobCardFormPanelFooterPadClass = "px-6 sm:px-8";
