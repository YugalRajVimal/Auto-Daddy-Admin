...
export const DUMMY_SHOP_EXPENSES: ShopWalletExpenseRow[] = [
  { id: "exp-1", date: "2026-05-24", vendor: "ABHAY", amount: 100, category: "other-expenses", subcategory: "misc", notes: "", gst: false, billNumber: null, byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("shop-expense-1") },
  ...
  { id: "exp-4", date: "2026-05-21", vendor: "SURBHI WEB DEV", amount: 350, category: "professional", subcategory: "software-charges", notes: "Website maintenance", gst: true, billNumber: "SWD-221", byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("shop-expense-4") },
  { id: "exp-5", date: "2026-05-20", vendor: "PAHADI-APP", amount: 500, category: "professional", subcategory: "software-charges", notes: "App subscription", gst: true, billNumber: null, byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("shop-expense-5") },
  ...
  { id: "exp-7", date: "2026-05-18", vendor: "DETAIL PRO", amount: 275, category: "car-vehicle", subcategory: "detailing", notes: "Fleet vehicle detailing", gst: true, billNumber: null, byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("shop-expense-7") },
  ...
  { id: "exp-10", date: "2026-05-10", vendor: "TORONTO HYDRO", amount: 320, category: "utilities", subcategory: "electricity", notes: "", gst: true, billNumber: "TH-99102", byCheque: false, hasReceipt: true, attachmentUrl: adminClipImageUrl("shop-expense-10") },
